...
namespace CrmIntractor.FunctionHelpers
{
    public  class Helper
    {
        ...
        public static Guid createLead(LeadInfo Lead, ILogger log)
        {
            using (var service = Helper.Service())
            {
                Entity lead = new Entity("lead");
                lead["subject"] = Lead.Topic??"Lead created via Azure Function";
                lead["lastname"] = Lead.LastName ?? "";
                lead["firstname"] = Lead.FirstName ?? "";
                lead["jobtitle"] = Lead.jobtitle ?? "unknown";
